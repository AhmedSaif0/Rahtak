        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/machinery" className="text-gray-300 hover:text-white">
                  الآليات الزراعية
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <svg className="h-5 w-5 ml-3 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
